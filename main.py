...
parser.add_argument('--epoch', dest='epoch', type=int, default=4, help='# of epoch')
parser.add_argument('--batch_size', dest='batch_size', type=int, default=200, help='# images in batch')
parser.add_argument('--lr', dest='lr', type=float, default=0.002, help='initial learning rate for DiscoGAN')
...
parser.add_argument('--is_result_clear', dest='is_resultclr', default=True, help='clear result dir ')
